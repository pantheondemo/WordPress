...
function hatch_theme_meta_box() { ?>
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<textarea id="<?php echo esc_attr( hybrid_settings_field_id( 'hatch_custom_css' ) ); ?>" name="<?php echo esc_attr( hybrid_settings_field_name( 'hatch_custom_css' ) ); ?>" cols="60" rows="8"><?php echo format_for_editor( stripslashes( hybrid_get_setting( 'hatch_custom_css' ) ) ); ?></textarea>
